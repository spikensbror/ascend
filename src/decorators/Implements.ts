 ...
 *
 * @param service The service type that the implementation implements or same as
 * the implementation if not specified.
 */
export function Implements(service: Function): (i: Function) => void {
